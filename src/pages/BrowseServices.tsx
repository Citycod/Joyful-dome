...
const BrowseServices = () => {
  ...
  const [filters, setFilters] = useState({
    category: searchParams.get('category') || '', // Initialize with URL category
    minPrice: '',
    maxPrice: '',
    delivery: '',
    rating: '',
  ...
  const filteredServices = services.filter((service) => {
    ...
    const matchesMinPrice = !filters.minPrice || service.price >= parseInt(filters.minPrice) || isNaN(parseInt(filters.minPrice));
    const matchesMaxPrice = !filters.maxPrice || service.price <= parseInt(filters.maxPrice) || isNaN(parseInt(filters.maxPrice));
    const matchesDelivery = !filters.delivery || service.delivery === filters.delivery;
    const matchesRating = !filters.rating || service.rating >= parseFloat(filters.rating) || isNaN(parseFloat(filters.rating));
    
    return matchesSearch && matchesCategory && matchesMinPrice && matchesMaxPrice && matchesDelivery && matchesRating;
  });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container px-4 py-8 mx-auto">
        <div className="flex flex-col gap-6 md:flex-row">
          {/* Sidebar */}
          <aside className="sticky w-full p-5 bg-white shadow-sm md:w-72 rounded-xl h-fit top-24">
            ...
            <div className="space-y-5">
              ...
              <div>
                <h3 className="mb-2 font-medium text-gray-900">Delivery Time</h3>
                <select
          ...
          <main className="flex-1">
            <div className="flex flex-col items-start justify-between gap-3 mb-6 sm:flex-row sm:items-center">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">{filteredServices.length} services available</p>
              </div>
              <div className="relative w-full sm:w-64">
                <input
                  ...
                  className="w-full py-2 pl-10 pr-4 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
                <svg 
              ...
              <select className="border border-gray-300 rounded-lg p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
